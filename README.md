...
[Data download](https://d396qusza40orc.cloudfront.net/exdata%2Fdata%2FNEI_data.zip)
...
1. Readme file.
2. Original datasets.
3. R projectfiles including 6 R script files and correpsonding PNG files generated from the codes.
